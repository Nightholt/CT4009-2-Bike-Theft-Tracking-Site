...
<body>
  ...
  <nav class="navbar navbar-expand-sm">
    <a class="navbar-brand" href="..\PoliceHome\PoliceHome.php">
      <img src="../../globalFiles/Logo.png" alt="Constabulary Logo" width="180px" height="60px">
    </a>
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link" href="..\PoliceHome\PoliceHome.php">Home </a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="..\StolenEcommerce\StolenEcommerce.php">Stolen Ecommerce </a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="..\UpdateInvestigationStatus\UpdateInvestigationStatus.php">Investigations </a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="..\VictimLocations\VictimLocations.php">Incident Locations </a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="..\ViewStolenList\ViewStolenList.php">View Stolen Bikes </a>
        </li>
      </ul>
        ...
        <ul class="navbar-nav ml-auto">
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="loginDropdown">
              <a id="dText" class="dropdown-item" href="..\..\Public\Login\Login.php">Login as Public</a>
              <a id="dText" class="dropdown-item" href="..\PoliceLogin\PoliceLogin.php">Login as Police</a>
            </div>
          </li>
        </ul>
